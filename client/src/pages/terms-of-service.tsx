        ...
        <Card className="max-w-4xl mx-auto">
          <CardContent className="p-8">
            ...
            <div className="prose max-w-none">
              ...
              <p>By accessing and using PrayerTrack, you agree to be bound by these Terms of Service.</p>

              <h2 className="text-xl font-semibold mt-8 mb-4">2. Use of Service</h2>
              <p>You agree to use PrayerTrack only for lawful purposes and in accordance with these Terms.</p>
              ...
              <p>All content provided in PrayerTrack is for informational purposes only.</p>
              ...
              <p>Email: info@ahlehadeeshyd.org</p>
            </div>
          </CardContent>
        </Card>
      </div>
